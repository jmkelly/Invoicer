...
INSERT INTO "MyAccounts" ("Id", "CompanyName", "Name", "BSB", "AccountNo", "StreetNumber", "Street", "City", "State", "Postcode")
VALUES
  ('e7c72d07-2a0d-4a94-9ac1-7e6c5e2d170a', 'MyCompany1', 'MyAccount1', 'MyBSB1', 'MyAccountNo1', '789', 'Sample Street 3', 'City3', 'State3', '12345'),
  ('f5381807-8df1-4c6c-8c15-4625cc419e41', 'MyCompany2', 'MyAccount2', 'MyBSB2', 'MyAccountNo2', '101', 'Sample Street 4', 'City4', 'State4', '67890');
...
INSERT INTO "Invoices" ("Id", "InvoiceCode", "ClientId", "CreatedAt", "UpddatedAt", "InvoiceStatus")
VALUES
  ('2c7a98f1-af90-4427-a5a1-6b9a9b70d837', 'INV-2023-001', 'a4f0f320-dc0a-44c4-9f68-79089f02062d', '2023-10-29', '2023-10-29', 1),
  ('4a49061b-9a0b-4f91-8bd0-1e70ed4b8c0b', 'INV-2023-002', 'd6b1b4f1-777d-4db4-9ce2-48c605b73264', '2023-10-30', '2023-10-30', 1);
