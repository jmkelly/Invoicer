-- Begin 001_Create.sql
create database invoicer;

-- End 001_Create.sql

-- Begin 20230902031627_InitialCreate.sql
...
-- End 20230902031627_InitialCreate.sql

-- Begin 20230902061418_AddMyAccountTable.sql
...
-- End 20230902061418_AddMyAccountTable.sql

-- Begin 20230902063721_AddPostcodeToMyAccount.sql
START TRANSACTION;
...
-- End 20230902063721_AddPostcodeToMyAccount.sql

-- Begin 20230903062555_CreateSettings.sql
START TRANSACTION;
...
-- End 20230903062555_CreateSettings.sql

-- Begin 20230909102827_CreateWorkItems.sql
...
-- End 20230909102827_CreateWorkItems.sql

-- Begin 20230923045029_AlterWorkItemToDateOnly.sql
START TRANSACTION;
...
-- End 20230923045029_AlterWorkItemToDateOnly.sql

-- Begin 20230924054953_CreateInvoice.sql
START TRANSACTION;
...
-- End 20230924054953_CreateInvoice.sql

-- Begin 20240106045054_AddMyAccountToInvoice.sql
START TRANSACTION;
...
-- End 20240106045054_AddMyAccountToInvoice.sql

-- Begin 20240106054359_AddExtaAccountDetails.sql
COMMIT;
...
-- End 20240106054359_AddExtaAccountDetails.sql

-- Begin 20240106083355_AddAbnToMyAccount.sql
START TRANSACTION;
...
-- End 20240106083355_AddAbnToMyAccount.sql

-- Begin 20250605111705_AddInvoiceDate.sql
CREATE TABLE IF NOT EXISTS "__EFMigrationsHistory" (
    "MigrationId" character varying(150) NOT NULL,
    "ProductVersion" character varying(32) NOT NULL,
    CONSTRAINT "PK___EFMigrationsHistory" PRIMARY KEY ("MigrationId")
...
-- End 20250605111705_AddInvoiceDate.sql
